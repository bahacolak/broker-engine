...
public class SellOrderSuccessStrategy implements OrderStrategy {
    private final OrderRepository orderRepository;
    private final WalletRepository walletRepository;

    public SellOrderSuccessStrategy(OrderRepository orderRepository, WalletRepository walletRepository) {
    ...
    public void adjustWallet(String orderId) {
        ...
        orderRepository.findById(Long.valueOf(orderId))
                .flatMap(o -> {
                    o.setOrderStatus(OrderStatus.DONE.label);
