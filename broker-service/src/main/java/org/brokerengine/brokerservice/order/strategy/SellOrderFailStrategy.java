...
public class SellOrderFailStrategy implements OrderStrategy {
    private final OrderRepository orderRepository;
    private final WalletRepository walletRepository;

    public SellOrderFailStrategy(OrderRepository orderRepository, WalletRepository walletRepository) {
