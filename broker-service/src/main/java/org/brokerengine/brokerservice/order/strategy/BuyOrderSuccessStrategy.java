...
public class BuyOrderSuccessStrategy implements OrderStrategy {
    private final OrderRepository orderRepository;
    private final WalletRepository walletRepository;

    public BuyOrderSuccessStrategy(OrderRepository orderRepository, WalletRepository walletRepository) {
